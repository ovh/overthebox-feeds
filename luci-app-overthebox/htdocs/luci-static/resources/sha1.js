(function () {
     ...
     */
    window.Sha1.hash = function(msg, options) {
     ...
     * @private
     */
    window.Sha1.f = function(s, x, y, z)  {
        switch (s) {
     ...
     */
    window.Sha1.utf8Encode = function(str) {
     ...
     */
    window.Sha1.hexBytesToString = function(hexStr) {
